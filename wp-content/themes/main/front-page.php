...
<section class="hm_frame3">
	<div class="frm-cntnr width--80">
		...
		<div class="button-hldr">
			<a href="<?php echo esc_url( $frame3['support_link'] ); ?>" class="button">Support</a>
		</div>	
	</div>
</section>
<?php endif; ?>
<section class="hm_frame6">
	<div class="frm-cntnr width--80 staggerup_hldr">
		<div class="frm-title staggerup">
			<h1><?php the_field('frame5_header'); ?></h1>
		</div>
...
<section class="hm_frame5">
	...
	<div class="gradient"></div>
	<div class="frm-cntnr width--80">
		<div class="rooster2 animate-left" style="background-image: url('<?php echo esc_url( $frame6['rooster'] ); ?>');"></div>
		<!-- <div class="sabong" style="background-image: url('<?php bloginfo('template_url'); ?>/images/logo.png');"></div> -->
		<div class="inlineBlock-parent">
			<div class="left-side staggerup_hldr1">
...
<section class="hm_frame4">
	...
	<div class="frm-cntnr width--80">
		<div class="inlineBlock-parent">
			<div class="left-side staggerup_hldr2">
				...
				<div class="button-hldr staggerup2">
					<a href="<?php echo esc_url( $frame4['news_link'] ); ?>" class="button">View More</a>
				</div>
			</div
			><div class="right-side fadeIn">
				<div class="inlineBlock-parent">
					<?php
					$args = array(
						'post_type' => 'post',
					...
					<?php if($_posts->have_posts()):?><?php while ($_posts->have_posts()): $_posts->the_post();?><div class="news-card">

		...
		animateEvents: function() {
            ...
            */
            ...
            $('.animate-left').each(function() {
	         ...
	         $('.hm_frame2').each(function() {
             	var controller = new ScrollMagic.Controller();
	            var tl = new TimelineMax({delay:0, repeat:0, repeatDelay:0});
		        tl.fromTo('.hm_frame2 .phone', 1,
	                    { x: "0%", y: "30%", opacity: "0", ease:Power0.easeIn },
	                    { x: "0%", y: "0%", rotation:"0", opacity: "1", ease:Bounce.easeNone })
		        .fromTo('.hm_frame2 .text-hldr', 1,
	                    { x: "0%", y: "10%", opacity: "0", ease:Power0.easeIn },
	                    { x: "0%", y: "0%", rotation:"0", opacity: "1", ease:Bounce.easeNone })
		        .fromTo('.hm_frame2 .text-cntnr', 1,
	                    { x: "0%", y: "10%", opacity: "0", ease:Power0.easeIn },
	                    { x: "0%", y: "0%", rotation:"0", opacity: "1", ease:Bounce.easeNone }, "-=0.5")
		        .fromTo('.hm_frame2 .button-hldr', 1,
	                    { x: "0%", y: "10%", opacity: "0", ease:Power0.easeIn },
	                    { x: "0%", y: "0%", rotation:"0", opacity: "1", ease:Bounce.easeNone }, "-=0.5")
	         ...
	         $('.hm_frame3').each(function() {
             	var controller = new ScrollMagic.Controller();
	            var tl = new TimelineMax({delay:0, repeat:0, repeatDelay:0});
		        tl.fromTo('.hm_frame3 .frm-title', 1,
	                    { x: "0%", y: "30%", opacity: "0", ease:Power0.easeIn },
	                    { x: "0%", y: "0%", rotation:"0", opacity: "1", ease:Bounce.easeNone })
		       	.fromTo('.hm_frame3 .chat-icon', 1,
	                    { x: "-10%", y: "0%", opacity: "0", ease:Power0.easeIn },
	                    { x: "0%", y: "0%", rotation:"0", opacity: "1", ease:Bounce.easeNone }, "-=0.5")
		       	.fromTo('.hm_frame3 .chat-calendar', 1,
	                    { x: "10%", y: "0%", opacity: "0", ease:Power0.easeIn },
	                    { x: "0%", y: "0%", rotation:"0", opacity: "1", ease:Bounce.easeNone }, "-=0.5")
		       	.fromTo('.hm_frame3 .text-hldr', 1,
	                    { x: "0%", y: "30%", opacity: "0", ease:Power0.easeIn },
	                    { x: "0%", y: "0%", rotation:"0", opacity: "1", ease:Bounce.easeNone }, "-=0.5")
		       		.fromTo('.hm_frame3 .button-hldr', 1,
	                    { x: "0%", y: "30%", opacity: "0", ease:Power0.easeIn },
	                    { x: "0%", y: "0%", rotation:"0", opacity: "1", ease:Bounce.easeNone }, "-=0.5")
